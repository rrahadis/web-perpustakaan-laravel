    ...
    <div class="box-body">
        <form action="{{ route('book.update', $book) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group @error('title') has-error @enderror">
                ...
                <input type="text" name="title" class="form-control" placeholder="Masukan Nama Judul.." value="{{ $book->title ?? old('title') }}">
                @error('title')
            ...
            <div class="form-group @error('description') has-error @enderror">
                ...
                <textarea name="description" id="" rows="3" class="form-control" placeholder="tuliskan deskripsi buku..">
